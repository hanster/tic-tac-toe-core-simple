...
module TicTacToeCore
  describe Board do
    ...
    def create_three_by_three_board(positions)
      Board.new(3, positions)
    end
    ...
    it "is finished when the board is full" do
      board = create_three_by_three_board([x_marker, x_marker, x_marker,
    ...
    it "is not finished when the board has a row with an empty marker" do
      board = create_three_by_three_board([x_marker, empty_mark, x_marker,
                         empty_mark, empty_mark, empty_mark,
                         empty_mark, empty_mark, empty_mark])
    ...
    it "checks all the middle horizontal row will cause a finished board" do
      board = create_three_by_three_board([empty_mark, empty_mark, empty_mark,
                         x_marker, x_marker, x_marker,
                         empty_mark, empty_mark, empty_mark])
      expect(board.finished?).to be true
    end
    ...
    it "checks all the left vertical row will cause a finished board" do
      board = create_three_by_three_board([x_marker, empty_mark, empty_mark,
    ...
    it "checks all the middle vertical row will cause a finished board" do
      board = create_three_by_three_board([empty_mark, x_marker, empty_mark,
    ...
    it "checks all the right vertical row will cause a finished board" do
      board = create_three_by_three_board([empty_mark, empty_mark, x_marker,
    ...
    it "return tie? true if the board is full and noone has won"do
      board = create_three_by_three_board([x_marker, o_marker, x_marker,
    ...
    it "returns the winner as o marker" do
      board = create_three_by_three_board([o_marker, empty_mark, empty_mark,
